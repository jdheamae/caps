    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        setUser({
          ...
          image_Url: data.image_Url || "prof.jpg", // Set the image URL from API
        });
      } catch (error) {
    ...
    uploadTask.on(
      ...
      async () => {
        try {
          ...
          // Immediately update the local avatar URL in state
          setUser((prev) => ({ ...prev, image_Url: downloadURL }));
  
          // Optionally: Update Firestore if you need to persist the avatar URL
      ...
      <div className="profile-container">
        <div className="profile-sidebar">
          <div className="profile-avatar">
            ...
            <button onClick={handleUpload}>Upload Avatar</button> {/* Add upload button */}
          </div>
        </div>
